...
INSERT INTO FENOMENO(CODIGO_FEN,CODIGO, NOMBRE_FEN, DESCRIPCION,ID_TEL) VALUES(1,'AA54', 'GRANIZO', 'TIPO DE PRECIPITACION SOLIDA QUE SE COMPONE DE HIELO',1);
INSERT INTO FENOMENO(CODIGO_FEN,CODIGO, NOMBRE_FEN, DESCRIPCION,ID_TEL) VALUES(2,'AA43','HURACAN', 'GRAN TORMENTA TROPICAL CARACTERIZADA POR GRANDES VIENTOS',2);
INSERT INTO FENOMENO(CODIGO_FEN,CODIGO, NOMBRE_FEN, DESCRIPCION,ID_TEL) VALUES(3, 'SSS5','TORNADO', 'COLUMNA DE AIRE CON GRAN VELOCIDAD ANGULAR',3);
INSERT INTO FENOMENO(CODIGO_FEN,CODIGO, NOMBRE_FEN, DESCRIPCION,ID_TEL) VALUES(4, 'DS','TSUNAMI', 'EVENTO QUIE INVOLUCRA GRANDES OLAS DE GRAN ENERGIA Y TAMAÑO',4);
...
VALUES(4, 3, 'admin', 'admin', 'ADMINISTRATOR', 'TOTAL', 1,'CI', '54025652', 'CONSTITUYENTE 1740', 'ricardo.boz@estudiantes.utec.edu.uy');
INSERT INTO USUARIO(ID_USUARIO, ID_TIPO, PASS, USUARIO, NOMBRE, APELLIDO, ESTADO, TIPODOC, NUMERODOC, DIRECCION, MAIL)
VALUES(2, 2, 'password', 'user', 'VOLUNTARY', 'FREE', 1,'PASAPORTE', 'ASP4488', '18 DE JULIO 115', 'PRUEBA.PRUEBA@HOTMAIL.COM');
INSERT INTO USUARIO(ID_USUARIO, ID_TIPO, PASS, USUARIO, NOMBRE, APELLIDO, ESTADO, TIPODOC, NUMERODOC, DIRECCION, MAIL)
VALUES(3, 3, 'experto', 'experto', 'EXPERT', 'PAYMENT', 1,'OTROS', '54025652', 'P SHERMAN CALLE WALLABY 42', 'EXPERTO@GMAIL.COM');
