...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "PDT"."SEQ_CARACTERISTICASID"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1  NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence GEOLOCALIZACIONID
--------------------------------------------------------

   CREATE SEQUENCE  "PDT"."SEQ_GEOLOCALIZACIONID"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1  NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence OBSERVACIONID
--------------------------------------------------------

   CREATE SEQUENCE  "PDT"."SEQ_OBSERVACIONID"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1  NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence USUARIOID
--------------------------------------------------------

   CREATE SEQUENCE  "PDT"."SEQ_USUARIOID"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1  NOORDER  NOCYCLE ;
--------------------------------------------------------
-- Secuencia Fenomneo
--------------------------------------------------------
	CREATE SEQUENCE "PDT"."SEQ_CODIGOFENOMENO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1  NOORDER  NOCYCLE ;
	
------	----------------------------------------------------
	--SECUENCIA LOCALIDAD
---	--------------------------------------------------------
	
	CREATE SEQUENCE "PDT"."SEQ_IDLOCALIDADID"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1  NOORDER  NOCYCLE ;

---------------------------------------------------------------
-- SECUENCIA ZONA
---------------------------------------------------------------
CREATE SEQUENCE "PDT"."SEQ_IDZONA"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1  NOORDER  NOCYCLE ;

---------------------------------------------------------------
-- SECUENCIA DEPARTAMENTO
----------------------------------------------------------------
CREATE SEQUENCE "PDT"."SEQ_IDDEPARTAMENTO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1  NOORDER  NOCYCLE ;

-------------------------------------------------------------------
-- secuencia que precisa jpa
-------------------------------------------------------------------
CREATE SEQUENCE "PDT"."HIBERNATE_SEQUENCE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1  NOORDER  NOCYCLE ;
...
--------------------------------------------------------
 ...
 --------------------------------------------------------
--  DDL for Index UK_CODIGO_OBS
-------------------------------------------------------- 
CREATE UNIQUE INDEX "PDT"."UK_CODIGO_OBS" ON "PDT"."OBSERVACIONES" ("CODIGO_OBS") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT)
  TABLESPACE "USERS" ;
...
INSERT INTO TELEFONO(ID_TEL, NOMBRE,NUMERO, CODIGO_FEN) VALUES (1,'RESCATE-911', 911, 1);
INSERT INTO TELEFONO(ID_TEL, NOMBRE,NUMERO, CODIGO_FEN) VALUES (2, 'BOMBEROS-08007474',08007474, 2);
INSERT INTO TELEFONO(ID_TEL, NOMBRE,NUMERO, CODIGO_FEN) VALUES (3, 'AYUDA-23658855',23658855, 3);
INSERT INTO TELEFONO(ID_TEL, NOMBRE,NUMERO, CODIGO_FEN) VALUES (4, 'DINAMA-23657448',23657448, 3);
...
INSERT INTO FENOMENO(CODIGO_FEN,CODIGO,ESTADO, NOMBRE_FEN, DESCRIPCION,ID_TEL) VALUES(5, 'DS','ACTIVO','TSUNAMI', 'EVENTO QUIE INVOLUCRA GRANDES OLAS DE GRAN ENERGIA Y TAMAÑO',4);
...
<<<<<<< Updated upstream
INSERT INTO OBSERVACIONES(ID_OBSERVACION, ID_USUARIO, CODIGO_OBS, CODIGO_FEN, ID_LOCALIDAD, DESCRIPCION, IMAGEN, LATITUD, LONGITUD, ALTITUD, ID_ESTADO, FECHAHORA)
  VALUES(1, 2, 1,1, 1, 'MUY INTENSA LA GRANIZADA POR AQUI', null, 37.5, 55.1, 33, 1, TO_DATE('2018/05/03 21:02:44', 'yyyy/mm/dd hh24:mi:ss'));
INSERT INTO OBSERVACIONES(ID_OBSERVACION, ID_USUARIO, CODIGO_OBS, CODIGO_FEN, ID_LOCALIDAD, DESCRIPCION, IMAGEN, LATITUD, LONGITUD, ALTITUD, ID_ESTADO, FECHAHORA)
  VALUES(2, 2, 2,2, 3, 'MUCHO VIENTO', null, 37.6, 55.135, 34, 1, TO_DATE('2019/10/28 19:02:44', 'yyyy/mm/dd hh24:mi:ss'));
INSERT INTO OBSERVACIONES(ID_OBSERVACION, ID_USUARIO, CODIGO_OBS, CODIGO_FEN, ID_LOCALIDAD, DESCRIPCION, IMAGEN, LATITUD, LONGITUD, ALTITUD, ID_ESTADO, FECHAHORA)
  VALUES(3, 1, 3, 3, 2, 'SE VUELA TODO!!', null, 38.5, 56.15, 26, 1, TO_DATE('2019/10/27 18:02:44', 'yyyy/mm/dd hh24:mi:ss'));
=======
INSERT INTO OBSERVACIONES(ID_OBSERVACION,CODIGO_OBS, ID_USUARIO, CODIGO_FEN, ID_LOCALIDAD, DESCRIPCION, IMAGEN, LATITUD, LONGITUD, ALTITUD, ID_ESTADO, FECHAHORA)
  VALUES(1,'id2', 2, 1, 1, 'MUY INTENSA LA GRANIZADA POR AQUI', null, 37.5, 55.1, 33, 1, TO_DATE('2018/05/03 21:02:44', 'yyyy/mm/dd hh24:mi:ss'));
INSERT INTO OBSERVACIONES(ID_OBSERVACION,CODIGO_OBS, ID_USUARIO, CODIGO_FEN, ID_LOCALIDAD, DESCRIPCION, IMAGEN, LATITUD, LONGITUD, ALTITUD, ID_ESTADO, FECHAHORA)
  VALUES(2,'id1', 2, 2, 3, 'MUCHO VIENTO', null, 37.6, 55.135, 34, 1, TO_DATE('2019/10/28 19:02:44', 'yyyy/mm/dd hh24:mi:ss'));
INSERT INTO OBSERVACIONES(ID_OBSERVACION,CODIGO_OBS, ID_USUARIO, CODIGO_FEN, ID_LOCALIDAD, DESCRIPCION, IMAGEN, LATITUD, LONGITUD, ALTITUD, ID_ESTADO, FECHAHORA)
  VALUES(3,'id3', 1, 3, 2, 'SE VUELA TODO!!', null, 38.5, 56.15, 26, 1, TO_DATE('2019/10/27 18:02:44', 'yyyy/mm/dd hh24:mi:ss'));
