...
INSERT INTO FENOMENO(CODIGO_FEN,CODIGO,ESTADO, NOMBRE_FEN, DESCRIPCION,ID_TEL) VALUES(4, 'SSS5','BLOQUEADO' ,'TORNADO','COLUMNA DE AIRE CON GRAN VELOCIDAD ANGULAR',3);
...
INSERT INTO USUARIO(ID_USUARIO, ID_TIPO, PASS, USUARIO, NOMBRE, APELLIDO, ESTADO, TIPODOC, NUMERODOC, DIRECCION, MAIL)
VALUES(5, 2, 'password', 'user', 'VOLUNTARY', 'FREE', 'BLOQUEADO','PASAPORTE', 'ASP4488', '18 DE JULIO 115', 'PRUEBA.PRUEBA@HOTMAIL.COM');
INSERT INTO USUARIO(ID_USUARIO, ID_TIPO, PASS, USUARIO, NOMBRE, APELLIDO, ESTADO, TIPODOC, NUMERODOC, DIRECCION, MAIL)
VALUES(6, 3, 'experto', 'experto', 'EXPERT', 'PAYMENT', 'INACTIVO','OTROS', '54025652', 'P SHERMAN CALLE WALLABY 42', 'EXPERTO@GMAIL.COM');
